...
const RidePopUp = (porps) => {
  return (
    <div>
      <h5 className='p-1 text-center absolute w-[93%] top-0' onClick={()=>{
        porps.setRidePopupPanel(false);
      ...
      <div className='flex items-center justify-between p-3 border-2 border-yellow-400 rounded-lg mt-4'>
        <div className='flex items-center gap-3 '>
          <img className='h-12 w-10 rounded-full object-cover' src='https://i.dailymail.co.uk/i/pix/2013/08/29/article-2405475-1B8389EE000005DC-718_634x550.jpg'/>
      ...
      <div  className='flex gap-2 flex-col justify-between items-center'>
        ...
        <div className='flex w-full mt-5 items-center justify-between'>
          ...
          <button onClick={()=>{
            porps.setConfirmRidePanal(true);
